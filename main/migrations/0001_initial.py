# Generated by Django 4.1 on 2023-04-27 15:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255)),
                ('method_folder', models.CharField(blank=True, max_length=255, null=True)),
                ('date_registered', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project_folder', models.CharField(blank=True, max_length=255, null=True)),
                ('date_registered', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sample_info', models.CharField(help_text='link to sample type-specific information', max_length=255, verbose_name='sample information file')),
                ('supplementary_file', models.CharField(blank=True, help_text='if applicable: datasheet, etc.', max_length=255, null=True, verbose_name='supplementary file path')),
                ('date_registered', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experiment_file', models.CharField(default='', max_length=255, verbose_name='experimental data file path')),
                ('date_registered', models.DateTimeField(auto_now_add=True)),
